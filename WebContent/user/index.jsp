	...
	<div id="top">
		<TABLE WIDTH="772" BORDER="0" height="79" align="center"
			...
			<TR>
				...
				<TD WIDTH="68" align="center"><s:a target="rightFrame"
						action="firstpage.action" id="first">
							首页
					</s:a></td>
				<td WIDTH="80" align="center"><s:a target="rightFrame"
						action="userteacher!getTeacher.action">
							教师介绍
					</s:a></td>
				<td WIDTH="80" align="center"><s:a target="rightFrame"
				...
				<td WIDTH="78" align="center"><s:a target="rightFrame"
						action="userppt!showPptList.action?pagecode=1">
							电子教程
					</s:a></td>
